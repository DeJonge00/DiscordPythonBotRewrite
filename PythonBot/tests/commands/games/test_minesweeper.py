...
from commands.games.minesweeper.game_instance import MinesweeperInstance, FLAG, MINE, UNGUESSED, LOSS, WIN, PLAYING
...
class Commands(unittest.TestCase):
    ...
    def test_read_parameters(self):
        ...
        self.assertEqual(Minesweeper.read_parameters('10000', '1000000000000000', '100000000000000000'), (50, 50, 2500))
