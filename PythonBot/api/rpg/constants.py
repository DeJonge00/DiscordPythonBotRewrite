...
names = {
    "role": [
        ...
        (
            "Sorcerer",
            "A mighty sorcerer cannot take hits very well, but excels in powerful offensive magical attacks",
        ),
        # Pet exp *= 1.3
        ...
        (
            "Samurai",
            "A battle-hardened samurai can withstand a great deal of damage done by any man or beast",
        ),
        ...
        (
            "Kitten",
            "A kitten cannot fight, cannot work, cannot train, but.. Wow! It is so adorable!",
        ),
    ]
}
...
monsters = [
    ...
    (
        "Honourable Samurai",
        element_none,
        "https://wallscover.com/images/samurai-wallpaper-7.jpg",
    ),
    (
        "Hungry Spirit",
        element_none,
    ...
    (
        "Fallen Friend",
        element_air,
        "https://pm1.narvii.com/6351/867f04184d535dedf5d2062f7c7cac46f94776bd_hq.jpg",
    ),
    (
        "Little Witch",
        element_air,
    ...
    (
        "Dullahan",
        element_dark,
        "https://pre00.deviantart.net/6c54/th/pre/f/2010/068/f/7/durarara___dusk_by_yumera.jpg",
    ),
    (
        "Hekatonkheires",
        element_dark,
    ...
    (
        "Skaven Assassin in Training",
        element_dark,
        "https://us.v-cdn.net/5022456/uploads/editor/tr/lllm5fvwginz.jpg",
    ),
    (
        "Horrifying Swamp Monster",
        element_dark,
        "http://batrock.net/animeimages/mushi05-01.JPG",
    ),
    (
        "Shirt and Scarf Combo",
        element_dark,
        "https://foregroundnoises.files.wordpress.com/2013/12/kill091.jpg",
    ),
    (
        "Awoken Spirit",
        element_holy,
    ...
    (
        "Elven Slave",
        element_holy,
        "http://whfb.lexicanum.com/mediawiki/images/thumb/4/44/DEW.JPG/293px-DEW.JPG",
    ),
    (
        "Elven Wanderer",
        element_holy,
    ...
    (
        "Mischievous Angel",
        element_holy,
        "https://i.pinimg.com/originals/b3/f1/78/b3f178548031613133515cb9028d7257.jpg",
    ),
    (
        "Lava Crocodile",
        element_fire,
    ...
    (
        "Crystal Lizard",
        element_ice,
        "http://darksouls3.wiki.fextralife.com/file/Dark-Souls-3/ravenous_liz.jpg",
    ),
    (
        "Dwarf of the Northern Mountains",
        element_ice,
    ...
    (
        "Lizardman with Magic Frost Weapon",
        element_ice,
...
bosses = [
    ...
    (
        "Lord of Change",
        element_air,
        "https://spikeybits.com/wp-content/uploads/2014/11/fateweaver.jpg",
    ),
    (
        "Valkia the Bloody",
        element_air,
    ...
    (
        "Thunder Demi-god",
        element_lightning,
        "https://1d4chan.org/images/thumb/f/f8/SigThor.jpg/850px-SigThor.jpg",
    ),
    (
        "Black Ork Boss",
        element_dark,
    ...
    (
        "Demon Prince",
        element_dark,
        "https://spikeybits.com/wp-content/uploads/2017/03/Demon-Prince.jpg",
    ),
    (
        "Unknown Mutation",
        element_dark,
    ...
    (
        "Experienced Dwarf King",
        element_holy,
        "https://vignette.wikia.nocookie.net/warhammerfb/images/f/fc/Thorgrim.jpg/revision/latest?cb=20160418145644",
    ),
    (
        "Spear of the Holy Church",
        element_holy,
        "http://www.postavy.cz/foto/halflight-spear-of-the-church-foto.jpg",
    ),
    (
        "Young Dragon",
        element_holy,
    ...
    (
        "Phoenix",
        element_fire,
        "http://i90.photobucket.com/albums/k276/starry1_night/phoenixskyJPG.jpg",
    ),
    (
        "Pyrese Dragon",
        element_fire,
    ...
    (
        "Yeti",
        element_ice,
        "https://img00.deviantart.net/b76e/i/2006/316/5/a/yeti_by_andreauderzo.jpg",
    ),
]
adventureSecrets = [
    ...
    (
        "someone thought you were a jester and gave you something out of pity",
        "Money",
        50,
    ),
    ...
    (
        "you found a nest of little griffins and made the wise decision to run",
        "Exp",
        100,
    ),
    ...
    (
        "you saw big creatures fighting in the distance and learned some moves",
        "Exp",
        250,
    ),
