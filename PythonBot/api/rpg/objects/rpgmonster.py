...
from api.rpg.constants import element_none
...
class RPGMonster(RPGCharacter):
    def __init__(
        self,
        name="Monster",
        picture_url="https://geekandsundry.com/wp-content/uploads/2016/01/beholder.jpg",
        health=30,
        damage=10,
        ws=1,
        ...
        self.level = level
        super(RPGMonster, self).__init__(
            name, picture_url, health, health, damage, ws, 0
        )
