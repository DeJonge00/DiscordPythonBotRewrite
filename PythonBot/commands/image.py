...
def embedded_pic(name: str, picture: str, image_list: [str], pic_number: int = None):
    ...
    u = (
        image_list[pic_number]
        if pic_number and pic_number < len(image_list)
...
class ImageCommands(Cog):
    ...
    @commands.command(
        pass_context=1,
        aliases=["avatar", "picture"],
        help="Show a profile pic, in max 200x200",
    )
    async def pp(self, ctx: Context, *args):
        if not await self.bot.pre_command(
            message=ctx.message, channel=ctx.channel, command="pp"
        ):
            return
        try:
    ...
    async def send_picture_template_command(
        self,
        message: Message,
        channel: TextChannel,
        command: str,
        ...
        if not await self.bot.pre_command(
            message=message, channel=channel, command=command, is_typing=False
        ):
            return
        if pic_number:
        ...
        if channel.guild.id not in image_spam_protection_removal:
            ...
            prev_time = self.image_timers.get(command).get(
                channel.id, datetime.utcfromtimestamp(0)
            )
        ...
        answer = embedded_pic(
            command, self.bot.user.avatar_url, pic_links, pic_number=pic_number
        )
    ...
    async def cat(self, ctx: Context, *args):
        ...
        await self.send_picture_template_command(
            ctx.message, ctx.channel, "cat", pic_links=image_links.cat, pic_number=arg
        )
    ...
    async def cute(self, ctx: Context, *args):
        ...
        await self.send_picture_template_command(
            ...
            ctx.channel,
            "cute",
            pic_links=image_links.cute_gifs,
            pic_number=arg,
        )
    ...
    async def cuddle(self, ctx: Context, *args):
        ...
        await self.send_picture_template_command(
            ...
            ctx.channel,
            "cuddle",
            pic_links=image_links.hug_gifs,
            pic_number=arg,
        )
    ...
    async def happy(self, ctx: Context, *args):
        ...
        await self.send_picture_template_command(
            ...
            ctx.channel,
            "happy",
            pic_links=image_links.happy_gifs,
            pic_number=arg,
        )
    ...
    async def lewd(self, ctx: Context, *args):
        ...
        await self.send_picture_template_command(
            ...
            ctx.channel,
            "lewd",
            pic_links=image_links.lewd_gifs,
            pic_number=arg,
        )
    ...
    async def love(self, ctx: Context, *args):
        ...
        await self.send_picture_template_command(
            ...
            ctx.channel,
            "love",
            pic_links=image_links.love_gifs,
            pic_number=arg,
        )
    ...
    async def nyan(self, ctx: Context, *args):
        ...
        await self.send_picture_template_command(
            ...
            ctx.channel,
            "nyan",
            pic_links=image_links.nyan_gifs,
            pic_number=arg,
        )
    ...
    async def plsno(self, ctx: Context, *args):
        ...
        await self.send_picture_template_command(
            ...
            ctx.channel,
            "plsno",
            pic_links=image_links.plsno_gifs,
            pic_number=arg,
        )
    ...
    async def sadness(self, ctx: Context, *args):
        ...
        await self.send_picture_template_command(
            ...
            ctx.channel,
            "sadness",
            pic_links=image_links.sad_gifs,
            pic_number=arg,
        )
