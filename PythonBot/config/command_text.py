...
response = [
    ...
    "I have become death, destroyer of worlds!" "Awwwwn",
    "ATTENTION *please*",
...
quotes_40k = [
    "It is better to live for the Emperor than to live for yourself!",
    "Witches and sorcerers! Their fate is sealed",
    "Burn in holy fire!",
    "Fear the Emperor's wrath!",
    "We are the bringers of death!",
    "Cleanse this place of xenos filth!",
    "The Emperor's light is my torch!",
    "Armor yourselves in faith!",
    "Heretical fire with never stop me!",
    "Set loose the chapter's fury!",
    "Feel the might of the righteous!",
    "There is no shelter for those who oppose the Imperium of Man!",
    "By the Emperor, what is that foul beast?",
    "A fine welcome for us, brothers. Return the greeting in kind!",
    "And we shall know no fear!",
    "He is with us! My faith is my shield, my fury is my sword!",
    "There is only the Emperor, He is our shield and protector!",
    "May all heretics join you in death",
    "This is Imperium territory now, we claim this in the Emperor's name!",
    ...
    "Non can withstand our faith!",
    "Die scum! No prisoners! For the Emperor!",
